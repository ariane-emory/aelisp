...
(defun mapcan (fun lst)
 ...
 (unless (list? lst) (error "LST must be a list"))
 (let (result tail new-tail)
  (while (and (not (nil? lst)) (nil? (setq new-tail (fun (car lst)))))
   (setq lst (cdr lst)))
  (when new-tail
   (setq result new-tail
    tail  (last new-tail)))
  (setq lst (cdr lst))
  (while (not (nil? lst))
   (setq new-tail (fun (car lst)))
   (unless (nil? new-tail)
    (rplacd! tail new-tail)
    (setq tail (last new-tail)))
   (setq lst (cdr lst)))
  result))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defun mapc (fun lst)
...
(defun transform-tree! (pred? fun tree)
 ...
 tree)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; (defun old-transform-tree (pred? fun obj)
;;  "Transform-Tree OBJ by replacing members matching PRED? with the result of
...
;;   (else
;;    (cons
;;     (transform-tree pred? fun (car obj))
;;     (transform-tree pred? fun (cdr obj))))))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defun transform-tree (pred? fun tree)
...
(defun copy-tree (tree)
 "Deep copy the tree TREE. Equivalent to using transform-tree with an always true PRED? and id as FUN?"
 (unless (list? tree) (error "TREE must be a list"))
 (when tree
  (let (result tail)
   (while tree
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; fancy output macros: these need to be reviewed and revised.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defun delq! (item lst)
 ...
 (while (and (cons? (cdr lst)) (eq? (car lst) item))
  (rplaca! lst (cadr lst))
  (rplacd! lst (cddr lst)))
 (when (and (null (cdr lst)) (eq? (car lst) item))
