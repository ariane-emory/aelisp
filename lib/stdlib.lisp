...
(setq! printn    (lambda args (nl) (apply print args)                         ))
(setq! putn      (lambda args (nl) (apply put   args)                         ))
(setq! writen    (lambda args (nl) (apply write args)                         ))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;)
(setq! princns   (lambda args (nl) (apply princ (intercalate " " args))       ))
(setq! printns   (lambda args (nl) (apply print (intercalate " " args))       ))
(setq! putns     (lambda args (nl) (apply put   (intercalate " " args))       ))
(setq! writens   (lambda args (nl) (apply write (intercalate " " args))       ))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;)
(setq! princni   (lambda (i . args) (nl) (apply princ (intercalate i args   ))))
(setq! printni   (lambda (i . args) (nl) (apply print (intercalate i args   ))))
(setq! putni     (lambda (i . args) (nl) (apply put   (intercalate i args   ))))
(setq! writeni   (lambda (i . args) (nl) (apply write (intercalate i args   ))))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;)
