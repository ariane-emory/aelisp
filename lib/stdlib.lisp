...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;)
(defmacro princni (i . args) (cons princn  (intercalate i args))               )
(defmacro printni (i . args) (cons printn  (intercalate i args))               )
(defmacro putni   (i . args) (cons putn    (intercalate i args))               )
(defmacro writeni (i . args) (cons writen  (intercalate i args))               )
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;)
(defmacro princns args       (cons princni (cons " " args))                    )
(defmacro printns args       (cons printni (cons " " args))                    )
(defmacro putns   args       (cons putni   (cons " " args))                    )
(defmacro writens args       (cons writeni (cons " " args))                    )
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;)
