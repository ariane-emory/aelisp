...
ae_obj_t * push_together_a_list_of_ints(void) {
  ...
  for (int ix = 2; ix < 5; ix++) {
    ...
    tailtip            = PUSH_BACK(tailtip, new_int);
...
#define ENV_TRIO                                                                                   \
  ae_obj_t * root   = ENV_NEW_ROOT(false, false, false);                                                  \
...
void fun_specialness(void) {
  SETUP_TEST;
  ae_obj_t * env = ENV_NEW_ROOT(false, false, false);
...
void core_cons_car_cdr(void) {
  ...
  ae_obj_t * const env  = ENV_NEW_ROOT(false, false, false);
    ...
    ae_obj_t * const args    = CONS(NEW_STRING("hello"),
                                    CONS(NEW_INT(5),
                                         CONS(NEW_CHAR('a'),
                                              CONS(SYM("abc"),
                                                   NIL))));
    ae_obj_t * const written = ae_core_write(env, args, LENGTH(args));
    NL;
    ...
    ae_obj_t * const args    = CONS(NEW_STRING("hello"),
                                    CONS(NEW_INT(5),
                                         CONS(NEW_CHAR('a'),
                                              CONS(SYM("abc"),
                                                   NIL))));
    ae_obj_t * const written = ae_core_print(env, args, LENGTH(args));
    NL;
    ...
    ae_obj_t * const args    = CONS(NEW_STRING("hello"),
                                    CONS(NEW_INT(5),
                                         CONS(NEW_CHAR('a'),
                                              CONS(SYM("abc"),
                                                   NIL))));
    ae_obj_t * const written = ae_core_princ(env, args, LENGTH(args));;
    NL;
