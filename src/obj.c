...
// Data
////////////////////////////////////////////////////////////////////////////////////////////////////
ae_obj_t   true_obj     = { .metadata = AE_SYMBOL, .sym_val = "t"  , .properties = NIL };
ae_obj_t   nil_obj      = { .metadata = AE_SYMBOL, .sym_val = "nil", .properties = NIL };
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// _rational_simplify method
////////////////////////////////////////////////////////////////////////////////////////////////////
static void ae_rational_simplify(ae_obj_t * const this) {
  assert(this);
...
bool ae_obj_special_symp(const ae_obj_t * const this) {
  ...
  return
    SYMBOLP(this) &&
    (SYM_VAL(this)[0] == '*') &&
    (SYM_VAL(this)[strlen(SYM_VAL(this)) - 1] == '*');
}
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// _set_property: this is incomplete and unused and will probably be removed
////////////////////////////////////////////////////////////////////////////////////////////////////
void ae_obj_set_property(ae_obj_t * const this, char * const key, ae_obj_t * const value) {
  assert(this);
  assert(key);
  assert(value);

  ae_obj_t * const plist = PROPS(this);
