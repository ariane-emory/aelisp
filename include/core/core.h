...
#define FOR_EACH_CORE_FUN_GROUP_2(DO)                                                                                   \
  ...
  DO(file_read,          false,          1,          1, "file-read",           FUNDEF_END)                              \
  ...
  DO(dirs,               false,          0,          1, "dirs-in",  "dirs",    FUNDEF_END)                              \
  DO(files,              false,          0,          1, "files-in", "files",   FUNDEF_END)                              \
  DO(fappend_string,     false,          2,          2, "file-append-string",  FUNDEF_END)                              \
  DO(fwrite_string,      false,          2,          2, "file-write-string",   FUNDEF_END)                              \
  DO(fread_string,       false,          1,          1, "file-read-string",    FUNDEF_END)                              \
...
#define FOR_EACH_CORE_FUN_GROUP_3(DO)                                                                                   \
  /*================================================================================================================*/  \
  DO(incr,         true,           1,          2,                              FUNDEF_END)                              \
  DO(decr,         true,           1,          2,                              FUNDEF_END)                              \
  /*================================================================================================================*/  \
...
#define FOR_EACH_CORE_FUN_GROUP_1(DO)                                                                                   \
  ...
  /*================================================================================================================*/  \
  DO(setq,         true,           1,  UNLIMITED,                              FUNDEF_END)                              \
  /*================================================================================================================*/  \
