...
#define FOR_EACH_CORE_FUN(DO)                                                                                          \
  ...
  DO(dobj,     false,                                                         FUNDEF_END ) /* debug data accessor   */ \
  DO(errmsg,   false,                                                         FUNDEF_END ) /* error accessor        */ \
  DO(errobj,   false,                                                         FUNDEF_END ) /* error accessor        */ \
  ...
  DO(properp,  false,                                                         FUNDEF_END ) /* reduceable            */ \
  DO(tailp,    false,                                                         FUNDEF_END ) /* reduceable            */ \
  DO(boundp,   false,                                                         FUNDEF_END )                             \
  ...
  DO(lambda,   true,                                                          FUNDEF_END )                             \
  DO(cond,     true,                                                          FUNDEF_END )                             \
  DO(let,      true,                                                          FUNDEF_END )                             \
  DO(let_star, true,                                                          FUNDEF_END )                             \
