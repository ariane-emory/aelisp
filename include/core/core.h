...
#define FOR_EACH_CORE_FUN_GROUP_2(DO)                                                                                         \
  ...
  DO(fappend_string,     false,          2,          2, "string-append-file",        FUNDEF_END)                              \
  DO(fwrite_string,      false,          2,          2, "string-write-file",         FUNDEF_END)                              \
  DO(fread_string,       false,          1,          1, "string-read-file",          FUNDEF_END)                             \
