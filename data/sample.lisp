...
(princ "2 Expanded     ") (write        (defmacro blam (x y) (list (+ x y))))  (nl)
(princ "2 Evaled:      ") (write (eval  (defmacro blam (x y) (list (+ x y))))) (nl)
(princ "2 Set:         ") (write blam)                                         (nl)
(princ "2 Ev. params;  ") (write (params blam))                                (nl)
(princ "2 Ev. body;    ") (write (body   blam))                                (nl)
(princ "AFTER") (nl)
(nl)
