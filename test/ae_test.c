...
expr_t* inner_list = CONS(quote_setq, CONS(INTERN("name"), CONS(quote_lambda, DOT(INTERN("params"), INTERN("body")))));
expr_t* list_expr = CONS(INTERN("list"), CONS(inner_list, NIL));
